...
public class TestData{
    ...
    static public var weekly: ChartData = ChartData(values: [("M",100),
                                                            ("T",120),
                                                            ("W",110),
                                                            ("T",140),
                                                            ("F",80),
                                                            ("S",90),
                                                            ("S",110)])
//    static public var monthlyFirst: ChartData = ChartData(values: [("JAN",100),
//                                                                   ("FEB",120),
//                                                                   ("MAR",110),
//                                                                   ("APR",140),
//                                                                   ("MAY",80),
...
//                                                                   ("NOV",80),
//                                                                   ("DEC",90)])
    static public var monthlyFirst: ChartData = ChartData(values: [("1",100),
                                                                   ("2",120),
                                                                   ("3",110),
                                                                   ("4",140),
                                                                   ("5",80),
